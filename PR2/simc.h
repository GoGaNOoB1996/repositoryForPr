...
// ГЉГ®Г­Г±ГІГ Г­ГІГ» ГЁ Г±ГІГ°ГіГЄГІГіГ°Г»
const int evemax = 1024;
const int signmax = 64;
const int hint = 33;
/*Г’Г°ГЂГЌГ‡ГЂГЉГІГЌГЋ-ГЋГ°Г€Г…ГЌГІГ€Г°ГЋГ‚ГЂГЌГЌГ»Г… ГЉГЋГЌГ±ГІГЂГЌГІГ»*/
...
// ГЏГ°Г®Г¶ГҐГ¤ГіГ°Г» Г¬Г®Г¤ГҐГ«ГЁГ°Г®ГўГ Г­ГЁГї:
double _clock();
void prnlt1(plistt&);
void prnlt(plistt&);
